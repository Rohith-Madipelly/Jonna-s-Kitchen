...
import Programs23 from "./Programs23";
import CarouselsBasic from "../../../../../../Components/UI/CarouselsBasic/CarouselsBasic";


const { width } = Dimensions.get('screen');

const Healthylifestyleprograms2 = () => {
                                        ...
                                        {APICallData ? APICallData.map((data, index) => (
                                            ...
                                            >
                                                ...
                                                {visibleIndex === index && <View>
                                                    ...
                                                    <Programs23 ProgramsName={"efd"} data={data}  programId={data.id}  />
                                                </View>}
...
export default Healthylifestyleprograms2
