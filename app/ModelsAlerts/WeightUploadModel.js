...
import { UpdateWeightYupSchema } from '../FormikYupSchema/UpdateWeightYupSchema';
import { ServerError } from '../Utils/ServerError';
import Loader1 from '../Utils/Loader1';
import { UserLoginApi, Weight_Details_API } from '../Utils/ApiCalls';
import { useSelector } from 'react-redux';
import CustomToaster from '../Utils/CustomToaster';
import ImagePickerBottomSheet from './ImagePickerBottomSheet';

const WeightUploadModel = ({ visible, title, message, onClose, onSubmit }) => {
    ...
    const { handleChange,
        ...
        validationSchema: UpdateWeightYupSchema,
    ...
    const submitHandler = async (values) => {
        ...
        try {
            setSpinnerbool(true)
            const res = await Weight_Details_API(values, token)
            ...
            if (res) {
                ...
                onSubmit(res.data.fileName,`${values.currentWeight} ${values.weightUnits}`)
                handleChange('file')("")
                    ...
                    <View style={ModelStylesCss.alertContainer} onStartShouldSetResponder={() => true}>
                        ...
                        <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                            ...
                            {!image && (
                                <>
                                    <TouchableOpacity
                                        style={ModelStylesCss.uploadButton}
                                        onPress={() => { 
                                            // openCamera();
...
{/* <GetImagePicker bottomSheet={bottomSheetRef} setVLAEDA={(e)=>openCamera(e)}/> */}
                            ...
                            <CustomTextInput3
                                ...
                                outlined
                                labelStyle={{ marginBottom: -2, marginTop: 20 }}
...
export default WeightUploadModel;
