        ...
        <View style={{ marginTop: 15 }}>
          ...
          <View style={[{ justifyContent: 'center', paddingHorizontal: 2, flexDirection: 'row', alignItems: 'center', marginTop: 15, }]}>
            <View style={{}}>
              ...
              <Text style={{ fontFamily: 'BalooTamma2', fontWeight: 500, fontSize: 14, color: '#000000', textAlign: "center" }}>{programData ?<>{DateHelper.getDayFromToday('15-10-2024')} out of {DateHelper.getDaysBtwDates(programData.mealPlanDetails.dietStartDate, programData.mealPlanDetails.endDate)}</>:"....."}</Text>
